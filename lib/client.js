...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = [
			...
			".dshc-textButton{flex:none;height:28px;border:1px solid var(--dsw-alias-border-l2);border-radius:6px;padding:0 12px;font-size:12px;line-height:26px;color:var(--dsw-alias-label-primary);cursor:pointer;background:var(--dsw-alias-fill-l2)}",
			...
			".dshc-drawer{position:absolute;top:0;right:0;bottom:0;width:min(540px,100%);background:var(--dsw-specific-menu);border-left:1px solid var(--dsw-alias-border-l2);box-shadow:var(--dsw-shadow-lv2);z-index:5;display:flex;flex-direction:column}",
			...
			return react_jsx_runtime.jsx(react.Fragment, {
				children: [
					...
					react_jsx_runtime.jsx(Field, {
						...
						hint: t("field.project.hint"),
						children: react_jsx_runtime.jsx("input", {
							className: "dshc-input",
							value: project,
							onChange: (e) => setProject(e.target.value),
							placeholder: "/Users/…/repos/walltech"
						})
					}),
					react_jsx_runtime.jsx("div", {
						className: "dshc-field",
		...
		function CronOverlay({ t }) {
			...
			react.useEffect(() => {
				...
				const onKey = (event) => {
					...
					else overlayStore.setOpen(false);
				};
		...
		const zh = {
			...
			"field.project": "项目",
			"field.project.hint": "工作目录绝对路径，例如 /Users/…/repos/walltech",
			"field.model": "模型 / 推理",
		...
		const en = {
			...
			"field.project.hint": "Absolute working directory, e.g. /Users/…/repos/walltech",
