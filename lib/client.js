...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CSS = [
			...
			// overlay, so the page scrolls and resizes naturally.
			".dshc-pageDrawer{flex:none;width:min(540px,44%);box-sizing:border-box;border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-specific-menu);flex-direction:column;display:flex}",
